...
*/
        ...
        System.out.println(Challenge.rps("paper", "rock"));
        System.out.println(Challenge.rps("paper", "scissors"));
        System.out.println(Challenge.rps("scissors", "scissors"));
        System.out.println(Challenge.rps("scissors", "paper"));
